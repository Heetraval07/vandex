...
export const services: Service[] = [
  ...
  { slug: 'aog-support', name: 'Emergency AOG Support', icon: Siren,
    short: 'Priority desk. Quote in minutes, parts on the next flight out.',
    ...
    points: ['Priority AOG desk', 'Next-flight-out and hand-carry options', 'Live shipment tracking updates', 'Priority customs pre-clearance'] },
