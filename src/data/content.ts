...
export const services: Service[] = [
  { slug: 'global-procurement', name: 'Global Procurement', icon: Globe2,
    ...
    description: 'VANDEX consolidates your material demand into a single procurement channel, sourcing across OEM, distributor, and surplus markets in the Americas, Europe, and Asia — then delivering to your dock with unified documentation.',
  ...
  { slug: 'parts-sourcing', name: 'Aircraft Parts Sourcing', icon: Search,
    ...
    description: 'Our sourcing desk specializes in locating scarce and out-of-production part numbers through teardown channels, operator surplus, and OEM alternates — with airworthiness documentation verified before we quote.',
  ...
  { slug: 'inventory-management', name: 'Inventory Management', icon: Boxes,
    ...
    description: 'VANDEX designs inventory programs — consignment stock, min/max replenishment, and rotable pools — that cut carrying cost while lifting service levels, backed by consumption analytics reviewed quarterly.',
  ...
  { slug: 'worldwide-logistics', name: 'Worldwide Logistics', icon: Plane,
    ...
    description: 'Positioned at the crossroads of global air cargo, VANDEX moves material door-to-door: DG-certified packing, temperature-controlled handling, and routing built around your maintenance slot — not the forwarder\u2019s schedule.',
  ...
  { slug: 'export-documentation', name: 'Export Documentation', icon: FileCheck2,
    ...
    description: 'Every VANDEX shipment moves with complete, compliant documentation — release certificates, export licences, EUC handling, and customs paperwork prepared by a team fluent in UAE, EU, and US export regimes.',
  ...
  { slug: 'vendor-management', name: 'Vendor Management', icon: Handshake,
    ...
    description: 'We maintain and continuously audit a global vendor network against ASA-100 aligned criteria — quality escapes, delivery performance, and documentation accuracy — so a single VANDEX account replaces dozens of supplier files.',
  ...
  { slug: 'technical-consultation', name: 'Technical Consultation', icon: Wrench,
    ...
    description: 'Our technical team supports interchangeability decisions, SB/AD material planning, and lease-return material reviews — turning IPC ambiguity into a confident purchase decision.',
  ...
  { slug: 'supply-chain-management', name: 'Supply Chain Management', icon: GitBranch,
    ...
    description: 'For operators who want material off their desk entirely, VANDEX runs the full chain — forecasting, purchasing, warehousing, repairs administration, and delivery to the aircraft — under one KPI-governed agreement.',
